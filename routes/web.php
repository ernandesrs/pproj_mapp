...
Route::group([
    ...
    Route::group([
        ...
        Route::get('/create', \App\Livewire\Admin\Roles\Index::class)->name('admin.roles.create');
        Route::get('{role}/edit', \App\Livewire\Admin\Roles\Index::class)->name('admin.roles.edit');
